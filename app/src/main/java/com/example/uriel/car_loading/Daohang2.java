...
public class Daohang2 extends Activity implements AMapNaviListener, AMapNaviViewListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.daohang2);
        ...
        mStartLatlng = new NaviLatLng(qidianweidu,qidianjingdu);
        mEndLatlng = new NaviLatLng(zhongdianjingdu,zhongdianweidu);
