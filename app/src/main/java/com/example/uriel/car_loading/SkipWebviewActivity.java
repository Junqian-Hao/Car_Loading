...
/**
 * Created by 郝俊谦 on 2016/5/26.
 */
public class SkipWebviewActivity extends AreaActivity implements DownloadListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.skip_webview);
        //设置标题栏高度
        findViewById(R.id.skip_top).getLayoutParams().height = StatusBarHeight.getStatusHeight(this);
        Intent intent = getIntent();
        String url = intent.getStringExtra("url");
        areaWebView = (WebView) findViewById(R.id.skip_webView);
